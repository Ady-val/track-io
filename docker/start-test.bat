@echo off
REM Track.IO - Iniciar entorno de Testing para Cypress
REM Este script inicia PostgreSQL y Backend en contenedores aislados para testing

echo ========================================
echo Track.IO - Entorno de Testing
echo ========================================
echo.
